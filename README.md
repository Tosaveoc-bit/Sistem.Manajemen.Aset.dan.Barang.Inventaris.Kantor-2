...
Tidak ada revisi terhadap Progres 1 karena seluruh kebutuhan fungsional, kebutuhan data, dan diagram proses telah sesuai dengan rancangan basis data.

Struktur database yang digunakan pada Progres 2 tetap mengacu pada kebutuhan data Progres 1 sehingga dapat langsung digunakan pada Progres 3 (Implementasi Database dan Pengujian).

### Yang perlu ditambahkan ke GitHub untuk Progres 2

* ERD lengkap (gambar PNG/JPG)
* Penjelasan entitas dan relasi
* Kamus Data (Data Dictionary)
* Normalisasi UNF → 1NF → 2NF → 3NF
* Revisi analisis kebutuhan (tidak ada revisi)

Saat lanjut ke Progres 3 nanti, struktur ini sudah siap untuk dibuat:

* `CREATE DATABASE`
* 6 tabel (`users`, `kategori`, `lokasi`, `aset`, `peminjaman`, `perawatan`)
* PK, FK, UNIQUE, NOT NULL
* Data dummy (INSERT)
* Minimal 10 query SQL
* Skenario pengujian.
